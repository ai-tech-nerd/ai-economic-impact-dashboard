  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-primary-50 border border-primary-200 rounded-xl p-4 flex items-center justify-between gap-4 flex-wrap">
        <div>
          <p className="text-sm font-medium text-primary-800">Want all five frameworks in one printable guide?</p>
          <p className="text-xs text-primary-600">Includes examples, quick-reference tables, and the full "Which Framework" decision guide.</p>
        </div>
        <a
          href="https://www.michaelkristof.com/ai-knowledge-center/implementation-guides/ai-prompting-framework-guide/"
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center gap-2 px-4 py-2 bg-primary-600 text-white rounded-lg hover:bg-primary-700 transition-colors text-sm font-medium no-underline whitespace-nowrap"
        >
